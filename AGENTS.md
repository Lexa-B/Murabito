...
│  └─ *_readme.md          design briefs (hex units, movement, actions, perception, debug): what is implemented and what is still design
├─ _Archives/
