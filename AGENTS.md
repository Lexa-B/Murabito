...
│  └─ *_readme.md          design briefs (hex units, movement, actions, perception): what is implemented and what is still design
├─ _Archives/
...
- **Check visual work by running the app**, `scripts/run.sh`, which finds the display itself and logs to `~/.cache/murabito/run.log`; the user looks and reports. There is no screenshot tool yet.
