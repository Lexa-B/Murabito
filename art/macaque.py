...
every joint. About 1.25 shaku (~38 cm) to the shoulder, feet on z = 0. The ears
are small and hidden in the ruff, so it has none.
"""
...
BROWN, FACE, SKIN = "macaque_brown", "macaque_face", "macaque_skin"
...
SPINE = [
    ...
    (0.50, 1.10, 0.20, 0.20, BROWN, BROWN),  # a short neck
    # head: big and round, about 1.3x natural, a ruff of fur round a broad, flat red face
    (0.56, 1.24, 0.25, 0.25, BROWN, BROWN),  # back of the head
    (0.72, 1.28, 0.27, 0.24, BROWN, BROWN),  # the ruff, the widest point
    (0.86, 1.22, 0.22, 0.22, FACE, FACE),  # face
    (0.94, 1.17, 0.15, 0.14, FACE, FACE),  # muzzle
]
NOSE_TIP = Vector((0, 0.98, 1.15))  # close behind the last ring: a flat face
RUMP_RINGS = (2, 3)  # stand upright, so the rump rounds off under the tail
