...
PALETTE = [
    ...
    ("eye_glint", "#F6F3EC"),
    # the green pheasant
    ("pheasant_green", "#177A5C"),
    ("pheasant_green_light", "#1E876A"),
    ("pheasant_green_deep", "#126C50"),
    ("pheasant_neck", "#1F3FA6"),
    ("pheasant_neck_light", "#2A4CB5"),
    ("pheasant_neck_deep", "#183594"),
    ("pheasant_back", "#B06A3E"),
    ("pheasant_back_light", "#BA7547"),
    ("pheasant_back_deep", "#A55F36"),
    ("pheasant_tail", "#A48C86"),
    ("pheasant_tail_light", "#AE9791"),
    ("pheasant_tail_deep", "#99817B"),
    ("pheasant_rump", "#86AECF"),
    ("pheasant_leg", "#8C8A8A"),
    ("pheasant_red", "#D4001F"),
